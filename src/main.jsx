...
function Footer(){
 return <footer className="footer"><div className="container footerGrid">
   ...
   <div className="social"><a href="mailto:techziouz@gmail.com" title="Email"><i className="fas fa-envelope"></i></a><a href="https://chat.whatsapp.com/HgxAB6HdLIICgItFEmEZ9p" target="_blank" rel="noreferrer" title="WhatsApp Community"><i className="fab fa-whatsapp"></i></a><a href="https://www.linkedin.com/company/techziouz/" target="_blank" rel="noreferrer" title="LinkedIn"><i className="fab fa-linkedin"></i></a><a href="https://www.instagram.com" target="_blank" rel="noreferrer" title="Instagram"><i className="fab fa-instagram"></i></a></div></div>
